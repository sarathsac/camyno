   ...
   <div id="comment-<?php comment_ID(); ?>" class="comment_container">
      ...
      <div class="comment-text">
         ...
         <?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) :
            ...
            <div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php printf( __( 'Rated %s out of 5.', 'canvys' ), $rating ); ?>">
         ...
         <?php if ( $comment->comment_approved == '0' ) : ?>
            ...
            <p class="meta"><em><?php _e( 'Your comment is awaiting approval', 'canvys' ); ?></em></p>
               ...
               <strong itemprop="author"><?php comment_author(); ?></strong> <?php
                  ...
                  if ( get_option( 'woocommerce_review_rating_verification_label' ) === 'yes' )
                     if ( wc_customer_bought_product( $comment->comment_author_email, $comment->user_id, $comment->comment_post_ID ) )
                        echo '<em class="verified">(' . __( 'verified owner', 'canvys' ) . ')</em> ';
