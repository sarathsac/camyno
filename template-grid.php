...
/**
 * Template Name: Grid - Display direct descedats as grid
 *
 * Grid page teplate
 *
 * @package    WordPress
...
// If a password is required, use the normal page template
...
if ( 'advanced' == get_post_meta( get_the_ID(), '_cv_active_editor', true ) ) {
   ...
   // Display the page grid
   ob_start();
   get_template_part( 'inc/content/page', 'grid' );
   if ( $grid = ob_get_clean() ) {
      echo cv_content_section( array(), $grid );
   }
