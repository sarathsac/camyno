...
if ( ! class_exists('CV_Fullscreen_LayerSlider') ) :
 ...
 * @since        Version 1.0
 */
class CV_Fullscreen_LayerSlider extends CV_Shortcode {
   ...
   public function __construct() {
      ...
      $this->config = array(
         ...
         'handle' => 'cv_fullscreen_layerslider',
         ...
         'explanation' => __( 'LayerSlider is a 3rd party plugin, and can only be created/edited from its respective plugin page. Once you have created at least one LayerSlider you will be able to easily display it using this module, make sure that the LayerSlider you select has been correctly set up as a Full-Width Slider meaning that the Slider Width has been set to 100%, the control for "Full-Width" has been turned on, and if your website is responsive enabled that the control for "Responsive" has been turned on.', 'canvys' ),
         ...
         'attributes' => array(
            ...
            new CV_Shortcode_Select_Control( 'id', array(
               'title'         => __( 'LayerSlider', 'canvys' ),
               'description'   => __( 'Select the LayerSlider to display, make sure the LayerSlider you select has been correctly set up to be displayed as a full-width slider. Refer to the explanation above for more information.', 'canvys' ),
               'default'       => 'none',
