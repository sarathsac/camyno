...
if ( ! class_exists('CV_Row_Divider') ) :
 ...
 * @since        Version 1.0
 */
class CV_Row_Divider extends CV_Shortcode {
   ...
   public function composer_additional_assets() { ?>
      ...
      <script id="cv-builder-cv_row_divider-script">
         (function($){
            "use strict";
            $(document).on( 'cv-composer-load-cv_row_divider', function() {
   ...
   public function callback( $atts, $content = null ) {
      ...
      switch ( $margins ) {
        ...
        case 'medium': $margins = '4em'; break;
        case 'large':  $margins = '7em'; break;
      }
