 ...
 * @since        Version 1.0
 */
class CV_Spacer_Row extends CV_Shortcode {
   ...
   public function __construct() {
      ...
      $this->config = array(
         ...
         'explanation' => __( 'This shortcode can be used to add any amount of vertical space between two rows.', 'canvys' ),
