 ...
 * @since        Version 1.0
 */
class CV_Map extends CV_Shortcode {
      ...
      $this->config = array(
         ...
         'attributes' => array(
            ...
            new CV_Shortcode_Text_Control( 'title', array(
               ...
               'description' => __( 'Optionally add a title to be displayed immediately before the map.', 'canvys' ),
            ) ),
            ...
            new CV_Shortcode_Number_Control( 'height', array(
               'title'       => __( 'Height', 'canvys' ),
               'description' => __( 'Specify the height for this map in pixels, enter a numeric value only.', 'canvys' ),
               'placeholder' => 300,
            ) ),
   ...
   public function composer_additional_assets() { ?>
      ...
      <script id="cv-builder-cv_map-script">
         (function($){
            "use strict";
            $(document).on( 'cv-composer-load-cv_map', function() {
   ...
   public function callback( $atts, $content = null ) {
      ...
      return $title . $script . $markers . '<div id="' . $id . '" class="cv-map" style="height:' . $height . 'px"></div>';
